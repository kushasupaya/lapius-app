...
const ContactSection = () => {
  return (
    <section
      className="w-full pb-5 lg:pb-[200px] scroll-mt-20"
      id="get-in-touch"
    >
      <div className="flex flex-col lg:flex-row bg-secondary relative ">
        ...
        <div className="container py-12 md:py-20 px-4  lg:px-0 lg:py-0 z-10 mx-auto lg:absolute lg:top-[60px] md:left-[calc((100vw-768px)/2)] lg:left-[calc((100vw-1024px)/2)] xl:left-[calc((100vw-1280px)/3)]">
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            <div className="lg:pt-[131px] lg:pb-[150px] px-4 flex justify-center">
              <div>
                ...
                <h2 className="text-2xl md:text-[34px]/[42px] text-white font-bold mt-6 mb-3">
                  Get in touch with us!
                </h2>
                <p className="text-base md:text-lg text-muted-foreground md:mb-6">

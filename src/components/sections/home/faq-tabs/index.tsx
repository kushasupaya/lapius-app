...
const FaqTabs = () => {
  ...
  return (
    <Tabs defaultValue="feature" className="w-full flex flex-col items-end">
      {
        tabs.length > 1 &&
        <TabsList className="h-16 w-fit bg-white p-2 border border-border rounded-[30px] gap-2.5 mb-6 ml-auto">
          {
            tabs.map((tab, index) => (

...
const FaqSection = () => {
  return (
    <section id="faq" className="bg-white scroll-mt-20">
      <div className="container mx-auto p-4 lg:px-0 md:pt-16 md:pb-24 2xl:px-36">
        <div className="flex flex-col mb-4 lg:mb-0 lg:flex-row lg:items-end gap-4 md:gap-12">
          <div className="flex flex-col">
            <h2 className="mt-2.5 flex-1 text-black text-3xl md:text-[34px]/[42px] font-bold text-left lg:mb-10 ">

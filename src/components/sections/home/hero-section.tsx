                ...
                <div className="flex flex-col justify-between md:min-h-screen">
                    <div>
                        ...
                        <div className="-mt-32 pb-6">
                            <h1 className="text-white text-[40px] font-semibold max-w-[600px]   leading-tight">
                                Take Control of Your Healthcare Costs with the
                                AI
                                <span
                            ...
                            <p className="mt-2 max-w-[550px] text-subtitle-white">
                                Transform your social media strategy with our
                                all-in-one platform designed to help you plan,
                                create, and analyze your content effortlessly.
                            </p>
                            <GetStartedButton />
                        </div>
                    </div>
